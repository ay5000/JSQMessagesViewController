Pod::Spec.new do |s|
	...
	s.resources				= 'JSQMessagesViewController/Assets/JSQMessagesAssets.bundle', 'JSQMessagesViewController/Assets/Strings/*.lproj', 'JSQMessagesViewController/**/*.{xib}' , 'JSQMessagesViewController/Assets/AudioRecording/*.png'
