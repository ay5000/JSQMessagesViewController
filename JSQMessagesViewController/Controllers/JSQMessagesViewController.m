...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Oana change
    CGFloat bubbleTopLabelInset = (avatarImageDataSource != nil) ? 60.0f : (60.0f - [JSQMessagesCollectionViewCell defaultAvatarViewSize].width);
    
    if (isOutgoingMessage) {
        cell.messageBubbleTopLabel.textInsets = UIEdgeInsetsMake(0.0f, 0.0f, 0.0f, bubbleTopLabelInset);
        cell.cellBottomLabel.textInsets = UIEdgeInsetsMake(0.0f, 0.0f, 0.0f, bubbleTopLabelInset); // Oana change
    }
    else {
